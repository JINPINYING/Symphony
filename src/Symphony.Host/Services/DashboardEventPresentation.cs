...
internal static class DashboardEventPresentation
{
    ...
    private static readonly Dictionary<string, string> FriendlyLabels = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["phase_unowned_pull_request_adopted"] = "Unowned PR entered into review",
        ["phase_escalation_rearmed"] = "Review re-armed at moved head",
        ["phase_automatic_review_redispatch_exhausted"] = "Automatic recovery spent",
